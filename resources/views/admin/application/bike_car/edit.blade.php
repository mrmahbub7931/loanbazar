    ...
    <div class="col-xl-11 mx-auto">
        ...
        @endif
            <div class="card-body p-5">
                ...
                <hr>
                <form class="row g-3" action="{{ route('admin.application.transport.update', $application->id) }}" enctype="multipart/form-data" id="applicationForm" method="post">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="col-md-4 col-12">
                        ...
                        <input type="text" class="form-control" id="insurance_date" name="insurance_date" value="{{ $application->insurance_date }}" readonly>
                    </div>
                    <div class="col-md-4 col-12">
                        <label for="receiving_address" class="form-label">Receiving Address</label>
                        <input type="text" class="form-control" id="receiving_address" name="receiving_address" value="{{ $application->receiving_address }}" readonly>
                    </div>
                ...
                <div class="col-md-4 col-12 mt-5">
                    ...
                    <button class="btn btn-primary"><a href="{{ Storage::disk('public')->url('frontend/assets/files/insurances/form/pdf/'.$application->file) }}" download class="text-white">Download File</a></button>
                </div>
            </div>
        </div>
    </div>
