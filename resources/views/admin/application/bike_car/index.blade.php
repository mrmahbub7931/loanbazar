...
@section('title', 'Life Insurance Application')
            ...
            <table id="applicationTable" class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $application->insurance_type }}</td>
                        ...
                        <td>
							...
							<div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-end">	
                                <a class="dropdown-item" href="{{ route('admin.application.transport.edit', $application->id) }}">Edit</a>
								<a onclick="deleteApplication({{$application->id}})" class="dropdown-item" href="javascript:;">Delete</a>
                                <form action="{{ route('admin.application.transport.destroy', $application->id) }}" method="post"
