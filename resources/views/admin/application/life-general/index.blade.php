                    ...
                    <tr>
                        ...
                        <td>
							...
							<div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-end">	
                                <a class="dropdown-item" href="{{ route('admin.application.life.edit', $application->id) }}">Edit</a>
								<a onclick="deleteApplication({{$application->id}})" class="dropdown-item" href="javascript:;">Delete</a>
                                <form action="{{ route('admin.application.life.destroy', $application->id) }}" method="post"
