    ...
    <div class="col-xl-11 mx-auto">
        ...
        <div class="card border-top border-0 border-4 border-primary">
            ...
            <div class="card-body p-5">
                ...
                <hr>
                <form class="row g-3" action="{{ route('admin.cards.store') }}" enctype="multipart/form-data" id="applicationForm" method="post">
                    @csrf
