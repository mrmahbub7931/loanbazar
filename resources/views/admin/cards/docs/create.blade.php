        ...
        @endif
            <div class="card-body p-5">
                <div class="card-title d-flex align-items-center">
                    ...
                    <h5 class="mb-0 text-primary">Create Card Service Required Docs</h5>
                </div>
                <hr>
                <form class="row g-3" action="{{ route('admin.cards.docs.store') }}" id="serviceDocsForm" method="post">
                    @csrf
                    <div class="col-md-12">
                    ...
                    <div class="col-md-6 col-12">
                        <select name="card_service_id" id="card_service_id">
