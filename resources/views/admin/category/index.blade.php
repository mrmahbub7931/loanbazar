...
<div class="card">
    ...
    <div class="ml-auto m-3">
        <a href="{{ route('admin.categories.create') }}" class="btn btn-sm btn-info px-5 text-white">New category</a>
    </div>
    <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td>
							...
							<div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-end">	
								...
								<a onclick="deleteCategories({{$category->id}})" class="dropdown-item" href="javascript:;">Delete</a>
