        ...
        @endif
            <div class="card-body p-5">
                <div class="card-title d-flex align-items-center">
                    ...
                    <h5 class="mb-0 text-primary">Update Counter</h5>
                </div>
                <hr>
                <form class="row g-3" action="{{ route('admin.counters.update',$counter->id) }}" id="counterForm" method="post">
                    @csrf
                    @method('PUT')
                    <div class="col-md-12">
                        <label for="title" class="form-label">Title</label>
                        <input type="text" class="form-control" id="title" name="title" value="{{$counter->title}}">
                    </div>
                    <div class="col-md-12">
                        <label for="card_disbursed" class="form-label">Card Disbursed</label>
                        <input type="text" class="form-control" id="card_disbursed" name="card_disbursed" value="{{$counter->card_disbursed}}">
                    </div>
                    
                    <div class="col-md-12">
                        <label for="client_served" class="form-label">Clients Served</label>
                        <input type="text" class="form-control" id="client_served" name="client_served" value="{{$counter->client_served}}">
                    </div>
                    
                    <div class="col-md-12">
                        <label for="loan_disbursed" class="form-label">Core loan Disbursed</label>
                        <input type="text" class="form-control" id="loan_disbursed" name="loan_disbursed" value="{{$counter->loan_disbursed}}">
                    </div>
