...
<div class="card">
    ...
    <div class="ml-auto m-3">
        <a href="{{ route('admin.insurance.create') }}" class="btn btn-sm btn-outline-success px-5 radius-30">Create Insurance Service</a>
    </div>
    <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td>
							...
							<div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-end">	
                                <a class="dropdown-item" href="{{ route('admin.insurance.edit', $insurance->id) }}">Edit</a>
								<a onclick="deleteInsurances({{ $insurance->id }})" class="dropdown-item" href="javascript:;">Delete</a>
                                <form action="{{ route('admin.insurance.destroy', $insurance->id) }}" method="post"
                                    style="display: none" id="delete-form-{{ $insurance->id }}">
                                    @csrf
                                    @method('DELETE')
                                </form>
							</div>
