        ...
        <div class="card border-top border-0 border-4 border-primary">
            ...
            <div class="card-body p-5">
                <div class="card-title d-flex align-items-center">
                    ...
                    <h5 class="mb-0 text-primary">Create Insurance post Item</h5>
                </div>
                <hr>
                <form class="row g-3" action="{{ route('admin.insurance.posts.store') }}" enctype="multipart/form-data" id="applicationForm" method="post">
                    @csrf
                    <div class="col-md-12">
