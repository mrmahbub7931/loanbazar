...
@section('title', 'Loans Docs')

@section('content')
<div class="card">
    
    <div class="ml-auto m-3">
        <a href="{{ route('admin.loans.docs.create') }}" class="btn btn-sm btn-outline-success px-5 radius-30">Create Loan Service Docs</a>
    </div>
    <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td>
							...
							<div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-end">	
                                <a class="dropdown-item" href="{{ route('admin.loans.docs.edit', $doc->id) }}">Edit</a>
								<a onclick="deleteCardsDocs({{$doc->id}})" class="dropdown-item" href="javascript:;">Delete</a>
                                <form action="{{ route('admin.loans.docs.delete', $doc->id) }}" method="post"
