        ...
        @endif
            <div class="card-body p-5">
                <div class="card-title d-flex align-items-center">
                    ...
                    <h5 class="mb-0 text-primary">Update Loan service</h5>
                </div>
                <hr>
                <form class="row g-3" action="{{ route('admin.loans.update', $loan->id) }}" enctype="multipart/form-data" id="LoanServiceForm" method="post">
                    @csrf
                    @method('PUT')
                    <div class="col-md-12">
                        <label for="service_title" class="form-label">Loan Title</label>
						<input class="form-control" type="text" id="service_title" name="service_title" value="{{ $loan->service_title }}">
                    </div>
                    
                    <div class="col-md-12">
                        <label for="title_description" class="form-label">Header Description</label>
						<textarea name="title_description" id="mytextarea" cols="30" rows="10">{{ $loan->title_description }}</textarea>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <img src="{{ Storage::disk('public')->url('frontend/assets/img/loans/'.$loan->header_image) }}" alt="" width="150" height="80" class="my-2">
                    </div>

                    <div class="col-md-12">
                        <label for="disclaimer" class="form-label">Disclaimer</label>
						<textarea name="disclaimer" id="disclaimer" cols="30" rows="10">{{ $loan->disclaimer }}</textarea>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row_service_inner" id="inner_row_s_{{$r}}">
                            ...
                            <div class="form-group mb-3"><label for="bank_logo">Bank Logo</label><input type="file" class="form-control" id="bank_logo" name="service[{{$r}}][bank_logo]" /><img class="p_card" src="{{ Storage::disk('public')->url('frontend/assets/img/loans/'.$row->bank_logo) }}" alt="" width="140" height="80" class="my-2"></div>
                            ...
                            <div class="form-group mb-3"><label for="ineterest_rate_range">Ineterest Rate Range</label><input type="text" name="service[{{$r}}][ineterest_rate_range]" id="ineterest_rate_range" class="form-control" value="{{ $row->ineterest_rate_range }}" /></div>
                            <div class="form-group mb-3"><label for="processing_fee">Processing Fee</label><input type="text" name="service[{{$r}}][processing_fee]" id="processing_fee" class="form-control" value="{{ $row->processing_fee }}" /></div>
                            <div class="form-group mb-3"><label for="loan_amount">Loan Amount</label><input type="text" name="service[{{$r}}][loan_amount]" id="loan_amount" class="form-control" value="{{ $row->loan_amount }}" /></div>
                            <div class="form-group mb-3"><label for="loan_tenure">Loan Tenure</label><input type="text" name="service[{{$r}}][loan_tenure]" id="loan_tenure" class="form-control" value="{{ $row->loan_tenure }}" /></div>
