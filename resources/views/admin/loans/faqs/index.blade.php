...
@section('title', 'Loans Faq')

@section('content')
<div class="card">
    
    <div class="ml-auto m-3">
        <a href="{{ route('admin.loans.faqs.create') }}" class="btn btn-sm btn-outline-success px-5 radius-30">Create Loan Service Faq</a>
    </div>
    <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td>
							...
							<div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-end">	
                                <a class="dropdown-item" href="{{ route('admin.loans.faqs.edit', $faq->id) }}">Edit</a>
								<a onclick="deleteFaqsDocs({{$faq->id}})" class="dropdown-item" href="javascript:;">Delete</a>
                                <form action="{{ route('admin.loans.faqs.delete', $faq->id) }}" method="post"
