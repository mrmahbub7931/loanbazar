...
<div class="card">
    ...
    <div class="ml-auto m-3">
        <a href="{{ route('admin.loans.create') }}" class="btn btn-sm btn-outline-success px-5 radius-30">Create Loan Service</a>
    </div>
    <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td>
							...
							<div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-end">	
                                <a class="dropdown-item" href="{{ route('admin.loans.edit', $loan->id) }}">Edit</a>
								<a onclick="deleteLoan({{ $loan->id }})" class="dropdown-item" href="javascript:;">Delete</a>
                                <form action="{{ route('admin.loans.delete', $loan->id) }}" method="post"
                                    style="display: none" id="delete-form-{{ $loan->id }}">
                                    @csrf
                                    @method('DELETE')
                                </form>
							</div>
