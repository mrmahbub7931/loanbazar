...
@section('content')
<form class="row g-3" action="{{ route('admin.posts.store') }}" enctype="multipart/form-data" id="applicationForm" method="post">
    @csrf
<div class="row">
        ...
        <div class="card border-top border-0 border-4 border-primary">
            ...
            <div class="card-body p-5">
                <div class="card-title d-flex align-items-center">
                    ...
                    <h5 class="mb-0 text-primary">New Post</h5>
                </div>
                <hr>
                    ...
                    <div class="col-md-12">
						...
						<textarea name="body" id="mytextarea" cols="30" rows="15"></textarea>
                    </div>
