    ...
    <div class="col-xl-11 mx-auto">
        ...
        <div class="card-body p-5">
            <div class="card-title d-flex align-items-center">
                ...
                <h5 class="mb-0 text-primary">Register Writer</h5>
            </div>
            <hr>
            <form class="row g-3" action="{{ route('admin.writers.store') }}" id="writerForm" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="col-md-12">
                    ...
                    <textarea name="writer_bio" id="mytextarea" cols="30" rows="10"></textarea>
                </div>
                <div class="col-md-12">
