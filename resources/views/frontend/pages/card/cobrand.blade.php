    ...
    <section class="wrapper bg-soft-light lb__page__header visa__card">
        <div class="container py-12 py-md-12">
            <div class="row text-center">
                <div class="col-12">
                    <div class="content">
                        <h1 class="text-white fs-40">CO-BRAND CARDS</h1>
                        <p class="text-white">A Card is a small rectangular piece of plastic issued by banks and financial institutions, containing personal data in a
                            machine-readable form and used mainly to obtain cash or credit. With respect to financial perspective, a card can be
                            categorized as Debit Card and Credit Card.</p>
                        <ul class="lb__breadcrumb">
                            <li><a href="#"><i class="uil uil-home"></i> Home</a></li>
                            <li><a href="#">Pages</a></li>
                            <li class="active">CO-BRAND Card</li>
                        </ul>
                    </div>
                </div>
            </div>
