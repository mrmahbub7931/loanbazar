    ...
    <section class="wrapper bg-soft-light lb__page__header visa__card">
        <div class="container py-12 py-md-12">
            <div class="row text-center">
                <div class="col-12">
                    <div class="content">
                        <h1 class="text-white fs-40">MASTERCARD</h1>
                        <p class="text-white">A MasterCard card is any electronic payment card that uses the MasterCard network for processing transaction
                            communications branded with a MasterCard logo. They can be credit, debit or prepaid cards. Like Visa, they make
                            partnerships with different cards. MasterCard is accepted in 210 countries.</p>
                        <ul class="lb__breadcrumb">
                            <li><a href="#"><i class="uil uil-home"></i> Home</a></li>
                            <li><a href="#">Pages</a></li>
                            <li class="active">MASTERCARD</li>
                        </ul>
                    </div>
                </div>
            </div>
