    ...
    <section class="wrapper bg-soft-light lb__page__header visa__card">
        <div class="container py-12 py-md-12">
            <div class="row text-center">
                <div class="col-12">
                    <div class="content">
                        <h1 class="text-white fs-40">Bike Loan</h1>
                        <p class="text-white">If you have been thinking about purchasing a bike in the near future but do not have the finances to do the same, a two
                            wheeler loan might help. With a bike loan, you do not have to shell out your savings as you can purchase your favorite bike
                            and pay back the loan amount via equated monthly installments.</p>
                        <ul class="lb__breadcrumb">
                            <li><a href="#"><i class="uil uil-home"></i> Home</a></li>
                            <li><a href="#">Pages</a></li>
                            <li class="active">Bike Loan</li>
                        </ul>
                    </div>
                </div>
            </div>
