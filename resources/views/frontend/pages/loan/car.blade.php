    ...
    <section class="wrapper bg-soft-light lb__page__header visa__card">
        <div class="container py-12 py-md-12">
            <div class="row text-center">
                <div class="col-12">
                    <div class="content">
                        <h1 class="text-white fs-40">Car Loan</h1>
                        <p class="text-white">It refers a sum lent to one party (the borrower) by the other party (banks & FIs) for a period fixed upon mutual agreement
                            with a commitment to repay the same with interest/profit under a pre-agreed time schedule for the purpose of purchasing
                            an automobile or a car for personal use.</p>
