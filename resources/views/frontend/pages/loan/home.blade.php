    ...
    <section class="wrapper bg-soft-light lb__page__header visa__card">
        <div class="container py-12 py-md-12">
            <div class="row text-center">
                <div class="col-12">
                    <div class="content">
                        <h1 class="text-white fs-40">Home Loan</h1>
                        <p class="text-white">The name itself describes what a house finance/home loan is. Basically it means a sum lent to one party (the borrower) by
                            the other party (banks & FIs) for a period fixed upon mutual agreement with a commitment to repay the same with
                            interest/profit under a pre-agreed time schedule for the purpose of constructing a house or purchasing a flat/apartment.</p>
