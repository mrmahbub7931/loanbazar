    ...
    <section class="wrapper bg-soft-light lb__page__header visa__card">
        <div class="container py-12 py-md-12">
            <div class="row text-center">
                <div class="col-12">
                    <div class="content">
                        <h1 class="text-white fs-40">Project Loan</h1>
                        <p class="text-white">Project Loan is provided to corporate borrowers for the purpose of capital expenditure including setting up of new/
                            additional manufacturing facilities, construction etc. Project loan is also available to acquire the fixed assets like land &
                            building, plant & machinery etc.</p>
                        <ul class="lb__breadcrumb">
                            <li><a href="#"><i class="uil uil-home"></i> Home</a></li>
                            <li><a href="#">Pages</a></li>
                            <li class="active">Project Loan</li>
                        </ul>
                    </div>
                </div>
            </div>
