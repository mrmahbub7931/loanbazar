    ...
    <section class="wrapper bg-soft-light lb__page__header visa__card">
        <div class="container py-12 py-md-12">
            <div class="row text-center">
                <div class="col-12">
                    <div class="content">
                        <h1 class="text-white fs-40">SME Loan</h1>
                        <p class="text-white">It refers to a sum lent to SMEs (the borrower) by the other party (banks & FIs) for a period fixed upon mutual agreement
                            with a commitment to repay the same with interest/profit under a pre-agreed time schedule for the purpose of conducting
                            business including working capital financing, expanding existing business and acquiring fixed asset(s).It can either be a
                            continuous or term loan in nature.</p>
                        <ul class="lb__breadcrumb">
                            <li><a href="#"><i class="uil uil-home"></i> Home</a></li>
                            <li><a href="#">Pages</a></li>
                            <li class="active">SME Loan</li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row align-items-center justify-content-between">
                            <div class="col-md-2 p-0 pr-15">
                                <div class="left-content">
                                    <img src="{{ asset('frontend/assets/img/card.png') }}" alt="">
                    ...
                    <div class="item-service mb-3">
                        <div class="row align-items-center justify-content-between">
                            ...
                            <div class="col-md-2 text-center p-0 pl-15">
                                ...
                                <a href="javascript:;" class="r__btn service__btn bg-green">Required Documents</a>
                ...
                <div class="row mt-4">
                    <div class="col">
                        <div class="left__docs_info">
                            ...
                            <div class="list__item mb-4">
                                <p> <strong class="bg__green">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Saepe, ad!</strong> </p>
                                <ul>
                                    <li>Lorem ipsum dolor sit amet.</li>
                                    <li>Lorem, ipsum dolor sit amet consectetur adipisicing.</li>
                                    <li>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Non alias voluptatem facere doloremque, at possimus.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
